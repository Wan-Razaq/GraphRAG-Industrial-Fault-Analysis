...
class BamlAsyncClient:
    ...
    async def ExtractFaultInfo(
      ...
      return cast(types.FaultReport, raw.cast_to(types, types, partial_types, False))
    
    async def ExtractFaultsFromImage(
        self,
        img: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> List[types.FaultReport]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      ...
      return cast(List[types.FaultReport], raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ExtractFaultInfo(
        self,
        log_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.FaultReport, types.FaultReport]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.FaultReport, types.FaultReport](
        raw,
        lambda x: cast(partial_types.FaultReport, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.FaultReport, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    
    def ExtractFaultsFromImage(
        self,
        img: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[List[partial_types.FaultReport], List[types.FaultReport]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[List[partial_types.FaultReport], List[types.FaultReport]](
        raw,
        lambda x: cast(List[partial_types.FaultReport], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(List[types.FaultReport], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
